...
class ParamController extends FOSRestController
{
    ...
    public function indexAction() {
        ...
        $operations = '[{"op" : "add", "path" : "/fields/System.State", "value" : "Resolved"}, {"op" : "add", "path" : "/fields/System.AssignedTo", "value" : "quentinbogoss58@hotmail.fr"}]';

        // retrieve a work item by its ID
        $response = $client->workItemTracking()->patchWorkItem(204, json_decode($operations));
